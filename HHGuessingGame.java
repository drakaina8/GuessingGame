...
// Class: CS &141 Hybrid 2
// Date: 2/27/2022
// Assignment: Guessing Game Lab #4
// Purpose: This program is a number guessing game. 
//          The computer will pick a random number and the user will input guesses. 
//          Prompts will hint to the user whether the number is higher or lower.
// Note: I hoped to shorten "Character.toLowerCase()" to something like
//       "c.toLowerCase()" or "lowerCase()" but couldn't figure it out.
